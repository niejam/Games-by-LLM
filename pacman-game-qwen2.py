...
GHOST_SPEED = 3
score = 0
AI_MODE_DURATION = 5000  # Duration of each AI mode in milliseconds
...
class Ghost:
    def __init__(self, color):
        ...
        self.last_mode_switch = pygame.time.get_ticks()  # Track time for mode switching
        self.direction = random.choice(["left", "right", "up", "down"])  # Initialize direction

    def switch_mode(self):
        current_time = pygame.time.get_ticks()
        if current_time - self.last_mode_switch > AI_MODE_DURATION:
